...
from src.storage.cosmos_store import CosmosKeyValueStore
...
async def test_get_managed_entry_returns_none_on_404(
    ...
    expected_id = compound_key(collection="client_storage", key=unique_key)
...
async def test_get_managed_entry_deserializes_entry_json(
    ...
    mock_container.read_item.return_value = {
        "id": compound_key(collection="client_storage", key=unique_key),
        "pk": compound_key(collection="client_storage", key=unique_key),
